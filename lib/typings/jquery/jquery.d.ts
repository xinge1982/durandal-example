...
interface JQueryStatic {
    ...
    getNamesCommand: any;
    allUserStatusNames: any;
    allControlmodes: any;
    allDeviceTypes: any;

    getDeviceTypeName(devicetype: string): any;

    processLogDateTimeArray: any;
    processLogDateTimeSingle: any;

    allPrintDataTypeName: any[];
    getPrintDataTypeName: any;
    allPrintTypeName: any[];
